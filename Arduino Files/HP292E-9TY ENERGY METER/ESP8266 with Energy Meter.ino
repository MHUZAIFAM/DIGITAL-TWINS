...
void loop() {
  ...
  while(Serial.available()){
    Serial.readBytes(IncomingBuffer, 57); // Reading 57 bytes into IncomingBuffer
  }
  ...
  if (calculatedCRC == receivedCRC) {
    ...
    Serial.print("\nPHASE CURRENTS:");
    Serial.print("\nIa: ");
    Serial.println((extractFloat(IncomingBuffer, 15)/100)*44.6);
    Serial.print("Ib: ");
    Serial.println(extractFloat(IncomingBuffer, 17)/100);
    Serial.print("Ic: ");
    Serial.println(extractFloat(IncomingBuffer, 19)/100);
    
    Serial.print("\nPHASE ACTIVE POWERS:");
    Serial.print("\nPa: ");
    Serial.println((extractFloat(IncomingBuffer, 21)*10)*44.6);
    Serial.print("Pb: ");
    ...
    Serial.print("\nPHASE POWER FACTOR:");
    Serial.print("\nPFa: ");
    Serial.println(extractFloat(IncomingBuffer, 45)/100);
    Serial.print("PFb: ");
    Serial.println(extractFloat(IncomingBuffer, 47)/100);
    Serial.print("PFc: ");
    Serial.println(extractFloat(IncomingBuffer, 49)/100);
    
    Serial.print("\nTOTAL POWER FACTOR");
    Serial.print("PFt: ");
    Serial.println(extractFloat(IncomingBuffer, 51)/100);
    
    Serial.print("\nFREQUENCY");
    Serial.print("Freq: ");
    Serial.println(extractFloat(IncomingBuffer, 53)/10);
